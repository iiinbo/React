            ...
            <div>
                ...
                <nav className="navbar navbar-expand-sm bg-dark navbar-dark">
                    <div className="container-fluid">
                        ...
                        <li className="nav-item">
                            <NavLink className="nav-link" to="/board/list">board게시판</NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink className="nav-link" to="/hero/list">hero게시판</NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink className="nav-link" to="/score/list">score게시판</NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink className="nav-link" to="#none">Comingsoon</NavLink>
                        </li>
                        <li className="nav-item">
